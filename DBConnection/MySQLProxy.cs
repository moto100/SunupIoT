// <copyright file="MySQLProxy.cs" company="Sunup">
...
namespace Sunup.DBConnection
{
    ...
    /// MySQLProxy.
    /// </summary>
    public sealed partial class MySQLProxy
    {
        /// <summary>
        /// 批量操作每批次记录数.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MySQLProxy"/> class.
        /// </summary>
        ...
        /// <param name="parms">查询参数.</param>
        /// <returns>返回影响的行数.</returns>
        public static int ExecuteNonQuery(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
        ...
        /// <param name="parms">查询参数.</param>
        /// <returns>返回结果集中的第一行第一列.</returns>
        public static object ExecuteScalar(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
            MySqlCommand command = new MySqlCommand();
            PrepareCommand(command, connection, transaction, commandType, commandText, parms);
        ...
        /// <param name="parms">查询参数.</param>
        /// <returns>返回结果集.</returns>
        public static DataSet ExecuteDataSet(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
            MySqlCommand command = new MySqlCommand();
