// <copyright file="MSSQLProxy.cs" company="Sunup">
// Copyright (c) Sunup. All rights reserved.
// </copyright>

namespace Sunup.DBConnection
{
    using System;
    using System.Data;
    ...
    /// MSSQLProxy.
    /// </summary>
    public sealed partial class MSSQLProxy
    {
        /// <summary>
        /// 批量操作每批次记录数.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MSSQLProxy"/> class.
        /// </summary>
        /// <param name="connectionString">数据库连接字符串.</param>
        public MSSQLProxy(string connectionString)
        {
        ...
        {
            return ExecuteNonQuery(this.connectionString, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteNonQuery(this.connectionString, commandType, commandText, parms);
        }
        ...
        {
            return ExecuteScalar<T>(this.connectionString, commandText, parms);
        }
        ...
        {
            return ExecuteScalar(this.connectionString, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteScalar(this.connectionString, commandType, commandText, parms);
        }
        ...
        {
            return ExecuteDataReader(this.connectionString, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataReader(this.connectionString, commandType, commandText, parms);
        }
        #endregion
        ...
        {
            return ExecuteDataRow(this.connectionString, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataRow(this.connectionString, commandType, commandText, parms);
        }
        ...
        {
            return ExecuteDataTable(this.connectionString, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataSet(this.connectionString, commandType, commandText, parms).Tables[0];
        }
        ...
        {
            return ExecuteDataSet(this.connectionString, CommandType.Text, commandText, parms);
        }
        ...
        {
            return ExecuteDataSet(this.connectionString, commandType, commandText, parms);
        }
        ...
        {
            BatchUpdate(this.connectionString, table);
        }
        ...
        {
            return BulkInsert(this.connectionString, table);
        }
        ...
        /// <param name="parms">查询参数.</param>
        /// <returns>返回影响的行数.</returns>
        public static int ExecuteNonQuery(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] parms)
        {
        ...
        /// <param name="parms">查询参数.</param>
        /// <returns>返回结果集中的第一行第一列.</returns>
        public static object ExecuteScalar(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] parms)
        {
            SqlCommand command = new SqlCommand();
            PrepareCommand(command, connection, transaction, commandType, commandText, parms);
        ...
        /// <param name="parms">查询参数.</param>
        /// <returns>返回结果集.</returns>
        public static DataSet ExecuteDataSet(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] parms)
        {
            SqlCommand command = new SqlCommand();
